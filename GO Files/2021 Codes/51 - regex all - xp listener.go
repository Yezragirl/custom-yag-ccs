{{/*regex .* XP System - Main command*/}}
{{dbSet .User.ID "join" (toString .Member.JoinedAt.Parse.Unix)}}
...
{{if eq .Channel.ID 584957111872782366}}{{sleep 1}}{{dbSet 18 "counter_count" 1}}{{end}}{{end}}
