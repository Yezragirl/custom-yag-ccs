...
"Description" "Admin Tames are the admins signature dino, painted in their signature colors, at max level!\nThe following list outlines each admins dino, and colors."
 ...
 (sdict "name" "__**Gamble**__" "value" "*Albino, Lemon Lime, Actual Black* - Tek Rex" "inline" false)
 (sdict "name" "__**Lady Dukes**__" "value" "*Purple, Black, Turquoise* - Tropical Wyvern" "inline" false)
 (sdict "name" "__**Draygoon**__" "value" "*Royalty, Medium Blue, Green* - Astrodelphis" "inline" false)
 (sdict "name" "__**Bug**__" "value" "*Cyan, Deep Pink, Lemon Lime* - R-Thylacoleo" "inline" false) 
 (sdict "name" "__**Rouge**__" "value" "*Cyan, Albino, Actual Black* - Voidwyrm" "inline" false) 
