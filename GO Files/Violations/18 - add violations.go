...
{{else}}
{{sendMessageNoEscape nil (joinStr "" (mentionRoleID 573210843840249889) ", " (getMember ($args.Get 1).ID).Nick " needs to be fined " (toString (toInt $fine)) " BBS for violations of Rule " (toString ($args.Get 0)) ".")}}
{{end}}
{{deleteTrigger 1}}
