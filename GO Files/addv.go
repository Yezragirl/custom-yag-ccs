...
{{end}}
{{if gt (toString $fine) "0"}}
{{sendMessageNoEscape 573860427721605120 (joinStr "" (mentionRoleID 573210843840249889) ", " (getMember ($args.Get 1).ID).Nick " needs to be fined " $fine " BBS for violations of Rule " ($args.Get 0) ".")}}
{{end}}
{{deleteTrigger 1}}
