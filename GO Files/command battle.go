...
{{$P1MAX := toInt ((dbGet $player1.ID "BattleHP").Value)}}{{if lt $P1MAX 25}}{{else}}{{$P1MAX = 25}}{{end}}
{{$P2MAX := toInt ((dbGet $player2.ID "BattleHP").Value)}}{{if lt $P2MAX 25}}{{else}}{{$P2MAX = 25}}{{end}}
{{$P1HP := $P1MAX}}
{{$P2HP := $P2MAX}}
