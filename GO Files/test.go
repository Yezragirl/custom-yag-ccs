...
{{if gt $maxW 0}}{{$desc =print $desc "🏆 | **Max Winners:** " $maxW}}
{{$desc =print $desc "\n\n🌟 | **Host:** " $.User.Mention "}}
{{editMessage $chan . (cembed "title" "**Giveaway Time!!**🎉🎉" "description" $desc "color" 16763170 "footer" (sdict "text" (print "ID: " $uID " | Giveaway Ends ")) "timestamp" $giveawaySdict.expiresAt)}}
